...
const INPUT1 = `on x=10..12,y=10..12,z=10..12
on x=11..13,y=11..13,z=11..13
off x=9..11,y=9..11,z=9..11
on x=10..10,y=10..10,z=10..10`

const INPUT2 = `on x=-20..26,y=-36..17,z=-47..7
...
const INPUT3 = `on x=-5..47,y=-31..22,z=-19..33
...
const INPUT4 = `on x=0..1,y=0..1,z=0..1`

func TestPart1(t *testing.T) {

	inputs := []string{INPUT1, INPUT2}
	expected := []int{39, 590784}
	for i := range inputs {
		content := []byte(inputs[i])
		res := run_part1(content)
		if res != expected[i] {
			t.Errorf("error in part 1: expected %d, got %d", expected[i], res)
		}
	}
}
...
func TestPart2_3(t *testing.T) {
	...
	content := []byte(`on x=0..1,y=0..1,z=0..1
...
func TestPart2_4(t *testing.T) {
	...
	content := []byte(`on x=0..5,y=0..0,z=0..0
